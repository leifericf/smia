...
(def ^:private result
  (epub/assemble book tokens {:identifier "urn:clj-book:the-book"}))
...
(deftest package-document-carries-dublin-core
  (let [opf (:content (entry "OEBPS/content.opf"))]
    ...
    (is (str/includes? opf "<dc:identifier id=\"book-id\">urn:clj-book:the-book</dc:identifier>"))
