(ns clj-book.highlight.registry
  ...
  (:require
   [clj-book.highlight.clojure :as clojure]
   [clj-book.highlight.groovy :as groovy]
   [clj-book.highlight.java :as java]
   [clj-book.highlight.kotlin :as kotlin]))
